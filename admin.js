...
{     
     ...
     btndashboard.style.background = 'rgb(1, 1, 46)';
...
function refreshDashboard()
{
  $.ajax({
    type: 'POST', 
    url: 'refdashboard.php', 
    data: {},
    success: function(response) {
     
      $('#fetchDashboard').empty();
      $('#fetchDashboard script').remove();
       $('#fetchDashboard').html(response)
...
{     
     ...
     btnlaptop.style.background = 'rgb(1, 1, 46)';
     btnaccount.style.background = 'none';
     manageAccount.style.display = 'none';
     printForm.style.display = 'none';
     btnprint.style.background = 'none';
...
{     
     ...
     btntools.style.background = 'rgb(1, 1, 46)';
     laptopInventory.style.display = 'none';
     btnlaptop.style.background = 'none';
     btnaccount.style.background = 'none';
     manageAccount.style.display = 'none';
...
{     
     ...
     btnlog.style.background = 'rgb(1, 1, 46)';
     toolInventory.style.display = 'none';
     btntools.style.background = 'none';
     laptopInventory.style.display = 'none';
     btnlaptop.style.background = 'none';
...
{     
     ...
     laptopInventory.style.display = 'none';
     btnlaptop.style.background = 'none';
     btnaccount.style.background = 'rgb(1, 1, 46)';
...
{     
     ...
     btnprint.style.background = 'rgb(1, 1, 46)';
     refereshPrint();
}
