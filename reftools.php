...
if (mysqli_num_rows($result)) {
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
        ...
        echo '<tr>
                ...
                <td>' . $rows['Quantity'] . '</td>
                <td>' . $rows['Status'] . '</td>
                <td><a onclick="deleteTool(' . $rows['ID'] . ')" type="button"
                        class="red-button">Delete</a>
                    <a onclick="toolconsUpdate(' . $rows['ID'] . ')" type="button"
                        class="blue-button">Update</a>
                    <a onclick="toolconsBorrow(' . $rows['ID'] . ')" type="button"
...
if (mysqli_num_rows($result3)) {
    ...
    while ($rows = mysqli_fetch_assoc($result3)) {
        ...
        echo '<tr>
                ...
                <td>' . $rows['Status'] . '</td>
                <td>
                    <a onclick="toolreturn(' . $rows['ID'] . ')" type="button"
