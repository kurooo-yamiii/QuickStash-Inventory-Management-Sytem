...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql2 = "DELETE FROM tlog WHERE TimeOut LIKE '%$delid%' OR TimeIn LIKE '%$delid%'";
    $result2 = mysqli_query($conn, $sql2);
  
    $sql3 = "DELETE FROM elog WHERE TimeOut LIKE '%$delid%' OR TimeIn LIKE '%$delid%'";
...
if ($result2 && $result3) {
    ...
    echo "History from the Date $delid were Deleted Successfuly";
    echo '</div>';
